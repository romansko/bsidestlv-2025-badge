...
function findWasmBinary() {
  var f = 'mini-rv32ima-golden.wasm';
  if (!isDataURI(f)) {
    return locateFile(f);
  }
  return f;
...
var _usart_send = Module['_usart_send'] = createExportWrapper('usart_send', 2);
var _w25q_cmd = Module['_w25q_cmd'] = createExportWrapper('w25q_cmd', 2);
